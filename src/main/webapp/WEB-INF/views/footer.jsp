	...
	<div class="footer">
		...
		<div style="width: 800px; display: inline-block; height: 10px">
			<div id="" class=""
				...
				<h3>
					<a href="javascript:" class="">회사소개</a>
				</h3>
				<div class="">
			...
			<div id="" class=""
				style="width: 100px; display: inline-block; vertical-align: bottom">
				<h3>
					<a href="javascript:" class="">사업소개</a>
				</h3>
				<div class="">
			...
			<div id="" class=""
				style="width: 100px; display: inline-block; vertical-align: bottom">
				<h3>
					<a href="<%request.getContextPath();%>" class="dropbtn">인재채용</a>
				</h3>
				<div class="">
			...
			<div id="" class=""
				style="width: 100px; display: inline-block; vertical-align: bottom">
				<h3>
					<a href="javascript:" class="">홍보센터</a>
				</h3>
				<div class="">
			...
			<div id="" class=""
				style="width: 100px; display: inline-block; vertical-align: bottom">
				<h3>
					<a href="javascript:" class="">고객지원</a>
				</h3>
				<div class="">
